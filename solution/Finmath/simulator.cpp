...
namespace finmath {
	...
	CorrelationGenerator::CorrelationGenerator(CorrelationMatrix& matrix, RandomGenerator& generator) : 
		...
		decomposed_correlation_matrix_(correlation_matrix_.cholesky_decomposition()),
	...
	void CorrelationGenerator::next_sample(void) {
		...
		for( int i = 0; i < decomposed_correlation_matrix_.rows(); i++ ) {
		...
		distribution_ = decomposed_correlation_matrix_ * distribution_;
	}
